...
function render() {
  ...
  html += '</div>';
  // 底部 dock: 切换 (原 .tab 样式) + 工具 (保存/导表)
  html += '<div class="dock-bar">';
  // 切换: 沿用原 .tab 样式, 功能完全不变 (切换 + 长按删除)
  ...
  // 工具按钮: 导表 + 保存 (原 .dock-btn 样式)
  html += '<span class="dock-sep"></span>';
  html += '<button class="dock-btn dock-save" id="tabSaveBtn" title="导出收益表"><span class="dock-ico">📊</span><span class="dock-lbl">导表</span></button>';
