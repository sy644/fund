          ...
          <table class="buy-table">
            ...
            <tbody>
              ${f.buys.map((b, bi) => {
                ...
                return `
              <tr>
                <td><input type="date" id="bdate-${i}-${bi}" value="${b.date||''}" data-short="${dateShort}" class="bcell bdate-slider" style="font-size:13px;padding:3px 6px"></td>
                ...
                <td><button class="del-btn" data-buy-del="${i}" data-idx="${bi}" style="display:none">×</button></td>
              </tr>
              `;}).join('')}
            </tbody>
            <tfoot>
