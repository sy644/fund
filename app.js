...
function buildTierTable(f) {
  ...
  for (let t = 10; t >= -10; t--) {
    ...
    if (t === 0) {
      // 基准行: 加仓金额 = 初期 × 倍数^buyStart (从 +buyStart 档降到基准, 降 buyStart 档)
        ...
        <div class="ring-left" style="min-width:0;max-width:100%;overflow:hidden;position:relative;z-index:2">
          <div class="param-panel" style="max-width:100%;min-width:0;overflow:hidden;position:relative;z-index:2">
            ...
            <div class="param-list">
              ...
              <div class="param-row" style="grid-area: 2 / 1"><input type="number" step="1" id="base-initShares-${i}" value="${f.initShares}" class="param-input" style="width:100%;min-width:0;max-width:100%;font-size:13px;box-sizing:border-box;overflow:hidden"></div>
